 ...
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @method $this appendHttpEquiv($keyValue, $content, $conditionalHttpEquiv = array())
 * @method $this appendName($keyValue, $content, $conditionalName = array())
 * @method $this appendProperty($property, $content, $modifiers = array())
 * @method $this appendItemprop($keyValue, $content, $modifiers = array())
 * @method $this offsetSetHttpEquiv($index, $keyValue, $content, $conditionalHttpEquiv = array())
 * @method $this offsetSetName($index, $keyValue, $content, $conditionalName = array())
 * @method $this offsetSetProperty($index, $property, $content, $modifiers = array())
 * @method $this offsetSetItemprop($index, $keyValue, $content, $modifiers = array())
 * @method $this prependHttpEquiv($keyValue, $content, $conditionalHttpEquiv = array())
 * @method $this prependName($keyValue, $content, $conditionalName = array())
 * @method $this prependProperty($property, $content, $modifiers = array())
 * @method $this prependItemprop($keyValue, $content, $modifiers = array())
 * @method $this setHttpEquiv($keyValue, $content, $modifiers = array())
 * @method $this setName($keyValue, $content, $modifiers = array())
 * @method $this setProperty($property, $content, $modifiers = array())
 * @method $this setItemprop($keyValue, $content, $modifiers = array())
 */
