 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Constraint_DomQuery extends PHPUnit\Framework\Constraint\Constraint
{
    /**#@+
     ...
     */
    public function evaluateZF($content, $assertType = '', $match = FALSE)
    {
     ...
     */
    public function fail(mixed $other, string $description, \SebastianBergmann\Comparator\ComparisonFailure $comparisonFailure = NULL): never
    {
        // require_once 'Zend/Test/PHPUnit/Constraint/Exception.php';
